# Install script for directory: /media/nlk/D/share/code/slam/视觉slam/Pangolin/tools/VideoJson
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/media/nlk/D/share/code/slam/视觉slam/Pangolin/build/tools/VideoJson/VideoJsonPrint")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonPrint"
         OLD_RPATH "/media/nlk/D/share/code/slam/视觉slam/Pangolin/build/src:"
         NEW_RPATH "")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/media/nlk/D/share/code/slam/视觉slam/Pangolin/build/tools/VideoJson/VideoJsonTransform")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/VideoJsonTransform"
